    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <motion.div 
          ...
          className="relative w-full max-w-2xl bg-editorial-paper p-10 shadow-2xl border border-editorial-border"
        >
          <button 
            onClick={onClose}
          ...
          <div className="mb-12">
            ...
            <h2 className="text-4xl font-serif">Support & Guidance</h2>
            <p className="font-serif italic text-editorial-muted mt-4 text-lg">
          ...
          <div className="mt-12 pt-8 border-t border-editorial-border flex justify-between items-center">
            <div className="font-mono text-[10px] uppercase tracking-widest text-editorial-muted">
              Version 1.2.4 • System Stable
            </div>
            <button 
              onClick={onClose}
              className="bg-editorial-ink text-editorial-paper px-8 py-3 font-mono text-[10px] uppercase tracking-widest hover:opacity-90 transition-opacity"
            >
              Get Started
            </button>
          </div>
