...
const InspirationView: React.FC = () => {
  ...
  const [thought, setThought] = useState<ThoughtOfDay | null>(null);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fallback data for preview/development when backend is not running
        setQuotes([
  ...
  return (
    <main className="p-4 md:p-8 space-y-6 md:space-y-8 max-w-7xl mx-auto overflow-y-auto h-full pb-24 md:pb-8">
