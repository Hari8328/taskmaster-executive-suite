...
export type View = 'dashboard' | 'projects' | 'tasks' | 'inspiration' | 'suggestions' | 'roadmap' | 'chat' | 'logs' | 'admin';
            ...
            <button
              ...
              className={cn(
                ...
                theme === t.id 
                  ...
                  : "border-transparent text-white/40 hover:text-white hover:bg-white/5 hover:border-white/5"
              )}
            >
              <t.icon size={16} />
