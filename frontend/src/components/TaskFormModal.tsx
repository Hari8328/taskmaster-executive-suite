...
import { taskService, categoryService, Category } from '../services/taskService';
...
const TaskFormModal: React.FC<TaskFormModalProps> = ({ task, isOpen, onClose, onSuccess }) => {
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-6 overflow-y-auto flex-1 custom-scrollbar text-left scroll-smooth">
              ...
              <div className="space-y-2.5">
                <div className="flex items-center justify-between">
                  ...
                  >
                    {isAiSuggesting ? (
                      ...
                      <Sparkles size={10} className="text-indigo-600 fill-indigo-200 animate-pulse" />
                    )}
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[
                    ...
                    { id: 'high', label: 'High 🔥', activeClass: 'bg-red-50 border-red-600 text-red-800 font-bold', inactiveClass: 'border-zinc-200 text-zinc-400 hover:border-red-300' }
                  ].map((p) => {
              ...
              <div className="space-y-2.5">
                ...
                <div className="flex flex-wrap gap-2 py-1 max-h-[120px] overflow-y-auto custom-scrollbar">
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          isSelected 
                            ? "bg-editorial-ink text-editorial-paper border-editorial-ink font-semibold" 
                            : "bg-transparent border-editorial-border/80 text-editorial-muted hover:border-editorial-ink hover:text-editorial-ink"
                        )}
                      >
                        <span>{cat.name}</span>
                  ...
                  {!isAddingCategory ? (
                    ...
                    <div className="flex items-center space-x-1.5 border border-editorial-border rounded-lg px-2 py-1 bg-white">
                      <input 
                        type="text"
              ...
              <div className="pt-6 border-t border-editorial-border/40 flex justify-end space-x-4 items-center">
                ...
                >
                  {loading ? (
                    <Loader2 size={13} className="animate-spin text-editorial-paper" />
                  ) : (
                    <Check size={13} className="text-editorial-paper" />
                  )}
