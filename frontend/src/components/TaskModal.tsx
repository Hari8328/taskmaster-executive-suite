...
const TaskModal: React.FC<TaskModalProps> = ({ task, isOpen, onClose, onEdit }) => {
              ...
              <div className="space-y-1">
                <div className="flex items-center space-x-2">
                  <span className={cn(
                    ...
                    task.priority === 'medium' ? "border-editorial-accent text-editorial-accent" : 
                    "border-editorial-muted text-editorial-muted"
                  )}>
            ...
            <div className="p-8 space-y-8">
              <div className="space-y-2">
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4">
                    {!substeps.length && !isBreakingDown && (
                      <button 
                    ...
                    {isBreakingDown && (
                      <div className="flex items-center space-x-3 text-editorial-muted p-4 bg-editorial-muted/5 border border-dashed border-editorial-border">
                    ...
                    {error && (
                      <p className="text-[10px] font-mono uppercase text-red-500 mt-2 italic px-2">{error}</p>
                    )}
                  </div>
                </div>
              </div>
